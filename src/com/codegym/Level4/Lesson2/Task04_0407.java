...
/* Write code to correctly count the number of cats created (count) and display the correct number of
cats on the screen.
...
•	The Cat class's variable count must be a static int, have a public access modifier, and be initialized
to zero.
